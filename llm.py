...
@dataclass
class ModelConfig:
    # Model architecture - scaled up for better math reasoning
    d_model: int = 768
    n_heads: int = 12
    n_layers: int = 12
    d_ff: int = 3072
    ...
    muon_lr: float = 0.008  # Slightly reduced for stability

    # Data parameters - optimized for math content
    max_seq_len: int = 1024  # Longer sequences for complex math problems
    ...
    # Wandb config
    wandb_project: str = "math-llm-nemotron"
